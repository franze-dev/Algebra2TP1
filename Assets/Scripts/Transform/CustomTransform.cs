...
namespace CustomMath
{
    public class CustomTransform : MonoBehaviour
    {
        ...
        {
            private CustomTransform outer;

            private int currentIndex = -1;

            public object Current => outer.GetChild(currentIndex);

            internal Enumerator(CustomTransform outer)
            {
                this.outer = outer;
            }
        ...
        internal Vec3 GetLocalEulerAngles(RotationOrder order)
        {

        }

        internal void SetLocalEulerAngles(Vec3 euler, RotationOrder order)
        {
        ...
        public void SetParent(CustomTransform p)
        {
            SetParent(p, true);
        }

        public void SetParent(CustomTransform parent, bool worldPositionStays)
        {
        }
